...
public class UpdateToDoItem implements RequestStreamHandler {
	...
	public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
	    ...
	    try {
	    	...
	    	if(taskId != null && taskName != null && userId != null) {
	    		UpdateItemResponse updateItemResponse = Util.updateTask(dynamoDbClient, tableName, userId, taskId, taskName, logger);
	    		responseBody.put("status", "success");
        		logger.log(responseBody.toJSONString());
        		responseHeaders.put("Access-Control-Allow-Headers", "Content-Type");
        		responseHeaders.put("Access-Control-Allow-Origin", "*");
        		responseHeaders.put("Access-Control-Allow-Methods", "OPTIONS,GET,PUT,POST");
